...
ifneq ($(ONEOS_BUILD),)
include vendor/oneos/config/BoardConfigOneOS.mk
endif
...
ifneq ($(ONEOS_BUILD),)
ifneq ($(wildcard device/oneos/sepolicy/common/sepolicy.mk),)
## We need to be sure the global selinux policies are included
## last, to avoid accidental resetting by device configs
$(eval include device/oneos/sepolicy/common/sepolicy.mk)
endif
endif
